...
<?php include 'includes/sidemenu.php'; ?>
                           ...
                           <div class="card-statistic-3">
                              <div class="align-items-center justify-content-between">
                                 <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                       <div class="banner-img">
                                          <img src="<?php echo base_url() ?>adminasstes/images/icons/word.svg" alt="">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="card-statistic-3">
                              <div class="align-items-center justify-content-between">
                                 <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                       <div class="banner-img">
                                          <img src="<?php echo base_url() ?>adminasstes/images/icons/ppt.svg" alt="">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="card-statistic-3">
                              <div class="align-items-center justify-content-between">
                                 <div class="row ">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                       <div class="banner-img">
                                          <img src="<?php echo base_url() ?>adminasstes/images/icons/pdf.svg" alt="">
                                       </div>
                                    </div>
                                 </div>
                              </div>
           ...
           <div class="form-group row mb-4">
                         <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Add Files</label>
                                   <div class="col-sm-12 col-md-2">
                                         <input type="text"  name="tit3" maxlength="40" class="form-control inputtags" placeholder="Title">
                                    </div>
