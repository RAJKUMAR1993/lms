...
<?php include 'includes/sidemenu.php'; ?>
									  ...
									  <div class="col-12 col-sm-6 col-md-6 col-lg-3">
										   <article class="article article-style-b">
											  <div class="article-header">
												 <div class="article-image" data-background="<?php echo base_url() ?>adminasstes/images/image-gallery/thumb/thumb-6.png">
												 </div>
											  </div>
											  <div class="article-details">
												 ...
												 <p>
													...
													hath first signs. A don't spirit gathered two under, lights said. May Multiply seasons you'll spirit tree morning
													hath first signs. A don't spirit gathered two under, lights said. May Multiply seasons you'll spirit tree morning
													hath first signs.
												 </p>
												 <div class="dropdown">
         ...
         <div class="form-group row mb-4">
							 ...
							 <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                       <input type="text"  name="author" maxlength="15"  required class="form-control">
                                    </div>
								 </div>
								 ...
								 <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                       <input type="text"  name="authordesc" maxlength="25"   required class="form-control">
                                    </div>
                                 </div>
